    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-4">
        ...
        <div>
            <label for="update_password_current_password"
                class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">{{ __('Password Saat Ini') }}</label>
        ...
        <div>
            <label for="update_password_password"
                class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">{{ __('Password Baru') }}</label>
        ...
        <div>
            <label for="update_password_password_confirmation"
                class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">{{ __('Konfirmasi Password Baru') }}</label>
