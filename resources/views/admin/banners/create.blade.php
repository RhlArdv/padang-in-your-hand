...
@section('page-header')
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Buat banner promosi/informasi baru untuk aplikasi mobile</p>
        </div>
    </div>
@endsection

@section('content')
    <form method="POST" action="{{ route('admin.banners.store') }}" enctype="multipart/form-data" class="max-w-2xl">
        @csrf
        <div class="bg-white rounded-2xl border border-gray-100 p-6 space-y-5 shadow-sm">
            ...
            <div>
                ...
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-2xl hover:border-indigo-500 transition-colors group relative cursor-pointer" id="drop-zone">
                    ...
                    {{-- Image Preview --}}
                    <div id="image-preview-container" class="hidden w-full flex flex-col items-center">
                        <img id="image-preview" src="#" alt="Preview" class="max-h-48 object-cover rounded-xl border border-gray-100 shadow-sm">
